...
#include "com.kosso.tidownloadmanager.TidownloadmanagerModule.h"
...
namespace titanium {
	namespace bindings {
		...
		BindEntry* TidownloadmanagerBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"com.kosso.tidownloadmanager.TidownloadmanagerModule", ::com::kosso::tidownloadmanager::TidownloadmanagerModule::bindProxy, ::com::kosso::tidownloadmanager::TidownloadmanagerModule::dispose}
			};
